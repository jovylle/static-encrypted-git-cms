...
function fetchFromSchemas(name: string): any {
  const schemas: Record<string, any> = {
    "personal-projects": {"type":"object","additionalProperties":false,"required":["projects"],"properties":{"projects":{"type":"array","items":{"$ref":"#/$defs/project"}}},"$defs":{"link":{"type":"object","required":["label","url"],"additionalProperties":false,"properties":{"label":{"type":"string","minLength":1},"url":{"type":"string","format":"uri"}}},"project":{"type":"object","additionalProperties":false,"required":["title","description","repo","updated_at","slug","status","private","fav","priority_score","tech","links"],"properties":{"title":{"type":"string","minLength":1},"description":{"type":"string"},"repo":{"type":"string","format":"uri"},"updated_at":{"type":"string","format":"date-time"},"created_at":{"type":"string","format":"date-time"},"slug":{"type":"string","minLength":1},"status":{"enum":["draft","published","private"]},"private":{"type":"boolean"},"fav":{"type":"boolean"},"priority_score":{"type":"integer","minimum":0,"maximum":1000},"tech":{"type":"array","items":{"type":"string","minLength":1}},"links":{"type":"array","minItems":1,"items":{"$ref":"#/$defs/link"}},"thumbnail":{"type":"string"},"language":{"type":"string"}}}}},
